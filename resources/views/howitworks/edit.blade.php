        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                ...
                <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                    ...
                    <li
                        class="relative before:content-['\ea54'] before:font-remix ltr:before:-right-1 rtl:before:-left-1  before:absolute before:text-[18px] before:-top-[3px] ltr:pr-4 rtl:pl-4 before:text-slate-400 dark:text-zink-200">
                        <a href="{{ route('howitworks.index') }}" class="text-slate-400 dark:text-zink-200">How It Works
                            List</a>
                    </li>
                                ...
                                <div class="rtl:md:text-start">
                                    <div class="bg-white shadow rounded-md dark:bg-zink-600">
                                        <div
                                            ...
                                            <h5 class="text-16" id="exampleModalLabel">Edit How It Works</h5>
                                        ...
                                        <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                                            <form onsubmit="return EditvalidateFile()" class="tablelist-form"
                                                action="{{ route('howitworks.update', $image->id) }}" method="POST"
                                                ...
                                                <div class="grid grid-cols-3 gap-4">
                                                        ...
                                                        <select id="Categoryid" name="Categoryid"
                                                            ...
                                                            @foreach ($categories as $category)
                                                                <option value="{{ $category->Categories_id }}"
                                                                    @selected($image->category_id == $category->Categories_id)>
                                                    ...
                                                    <div class="mb-3 ">
                                                        ...
                                                        <input type="file" id="editmain_img" name="editmain_img"
                                                            ...
                                                            autocomplete="off">
                                                        <div id="viewimg">
                                                            <img src="{{ asset('upload/Image/') . '/' . $image->image }}"
                                                                height="70" width="70" alt="">

                                                        </div>
                                                    </div>
                                                    <input type="hidden" name="hiddenPhoto" class="form-control"
                                                        value="{{ old('editmain_img') ? old('editmain_img') : $image->image }}"
                                                        id="hiddenPhoto">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea id="description" name="editdes" class="ckeditor-classic text-slate-800" style="height: 300px !important;">{{ $image->description }}</textarea>
                                                </div>
