...
<div
    ...
    <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        ...
        <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
            <div class="grow">
                <h5 class="text-16">Sub category List</h5>
            </div>
                            ...
                            <div class="rtl:md:text-start">
                                <div class="bg-white shadow rounded-md dark:bg-zink-600">
                                    <div
                                        ...
                                        <h5 class="text-16" id="exampleModalLabel">Add Sub category</h5>
                                    </div>
                                    <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                                        <form method="POST" onsubmit="return validateFile()"
                                            action="{{ route('sub_categories.store') }}" id="registerForm"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select id="category-field" name="Categoryid"
                                             ...
                                             <div class="mb-3">
                                                <label for="email-field"
                                                    class="inline-block mb-2 text-base font-medium">flag<span
                                                        class="text-red-500"> *</span> </label>
                                                <select id="category-field" name="sub_rat_flag"
                                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                    required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="email-field" name="SubCategoryname"
                                                    maxlength="100"
                                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                    placeholder="Enter SubCategory Name" required autocomplete="off"
                                                    autofocus>
                                             ...
                                             <div class="mb-3">
                                                <label for="email-field"
                                                    class="inline-block mb-2 text-base font-medium">Title
                                                     </label>
                                             ...
                                             <div class="mb-3">
                                                <label for="email-field"
                                                    class="inline-block mb-2 text-base font-medium">SubTitle
                                                      </label>

                                                <input type="text" id="email-field" name="SubTitle"
                                                    maxlength="255"
                                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                    placeholder="Enter SubTitle Name"  autocomplete="off"
                                                    autofocus>
                                            ...
                                            <div class="mb-3">
                                                <label for="email-field"
                                                    class="inline-block mb-2 text-base font-medium">Sub Category
                                                    Image</label>
                                                <input type="file" id="SubCategoryimage" name="SubCategoryimage"
                                                    maxlength="150"
                                                    class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                    placeholder="Enter SubCategory Image" autocomplete="off"
                                                    autofocus>
                    ...
                    <div class="card-body">
                        ...
                        <div class="overflow-x-auto">
                            ...
                            <form id="bulkDeleteForm" method="POST"
                                action="{{ route('sub_categories.deleteselected') }}">
                                @csrf
                                @method('DELETE')
                                ...
                                <table class="w-full whitespace-nowrap" id="customerTable">
                                    <thead class="bg-slate-100 dark:bg-zink-600">
                                        <tr>
                                            ...
                                            <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 "
                                                data-sort="state_name">Sub Category Name </th>


                                            <th class="sort px-3.5 py-2.5 font-semibold border-b border-slate-200 dark:border-zink-500 "
                                                data-sort="state_name">Sub Category Image </th>
                                    ...
                                    <tbody class="list form-check-all">
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 Categories_img"
                                                style="">
                                                @if ($subcategory->SubCategories_img)
                                                <img class="img-fluid"
                                                    src="{{ asset('upload/subcategory-images') . '/' . $subcategory->SubCategories_img }}"
                                            ...
                                            <td
                                                ...
                                                <div class="items-center">
                                                    <div
                                                        ...
                                                        @if ($subcategory->iStatus == 1)
                                                        <input type="checkbox" name="greenIconSwitch"
                                                            id="greenIconSwitch{{ $subcategory->iSubCategoryId }}"
                                                            ...
                                                            onchange="updateStatus(<?= $subcategory->iStatus ?>,<?= $subcategory->iSubCategoryId ?>);"
                                                            checked="">
                                                        @else
                                                        <input type="checkbox" name="greenIconSwitch"
                                                            id="greenIconSwitch{{ $subcategory->iSubCategoryId }}"
                                                        ...
                                                        @endif
                                                        <label
                                                            for="greenIconSwitch{{ $subcategory->iSubCategoryId }}"
                                                ...
                                                <div class="gap-2">
                                                    <div class="edit">
                                                        <a class="mx-1" title="Edit" href="#"
                                                            ...
                                                            onclick="getEditData(<?= $subcategory->iSubCategoryId ?>)">
                                                            <i class="ri-edit-2-fill"></i>
                                                        </a>

                                                        <a class="mx-1" title="Delete" href="#"
                                                            onclick="confirmSingleDelete({{ $subcategory->iSubCategoryId }})">
            ...
            <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
                ...
                <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                    <form class="tablelist-form" onsubmit="return EditvalidateFile()"
                        action="{{ route('sub_categories.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3">
                          ...
                          <div class="mb-3">
                            <label for="Countryname-field" class="inline-block mb-2 text-base font-medium">flag
                                
                                <span class="text-red-500"> *</span>
                            </label>
                            <select id="edit_flag" name="edit_flag"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                required>
                                <option value="" disabled selected>Select a flag</option>
                                <option value="0">Service</option>
                        ...
                        <div class="mb-3">
                            <label for="email-field" class="inline-block mb-2 text-base font-medium">Sub Category
                                Name<span class="text-red-500"> *</span> </label>

                            <input type="text" id="editSubCategoryname" name="SubCategoryname" maxlength="100"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                placeholder="Enter SubCategory Name" required autocomplete="off" autofocus>

                        </div>
                        
                        <div class="mb-3">
                            <label for="email-field" class="inline-block mb-2 text-base font-medium">Title
                                 </label>

                            <input type="text" id="editTitle" name="Title" maxlength="40"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                        ...
                        <div class="mb-3">
                            <label for="email-field" class="inline-block mb-2 text-base font-medium">SubTitle
                                 </label>

                            <input type="text" id="editSubTitle" name="SubTitle" maxlength="40"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                placeholder="Enter Sub Title Name" autocomplete="off" autofocus>
                        ...
                        <div class="mb-3">
                            <label for="email-field" class="inline-block mb-2 text-base font-medium">Sub Category
                                Image </label>
                            <input type="file" id="EditSubCategoryimage" name="EditSubCategoryimage"
                                maxlength="150"
                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                placeholder="Enter SubCategory Icon" autocomplete="off" autofocus>
                            <input type="hidden" name="hiddensubimage" id="hiddensubimage" value="">
...
<script>
    function getEditData(id) {
        var url = "{{ route('sub_categories.edit', ':id') }}";
        ...
        if (id) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var imageUrlimg = obj.SubCategories_img ?
                        "{{ asset('upload/subcategory-images') }}/" +
                        obj
                        .SubCategories_img : "{{ asset('assets/images/noimage.png') }}";
                    $("#categoryselected").val(obj.iCategoryId);
                    $("#hiddensubimage").val(obj.SubCategories_img ? obj.SubCategories_img : '');
                    $("#EditsubCategoryImage").attr('src', imageUrlimg);

                    $('#iSubCategoryId').val(id);
                    $('#editSubCategoryname').val(obj.strSubCategoryName);
                    $('#editTitle').val(obj.title);
                    $('#editSubTitle').val(obj.sub_title);
                    $('#edit_flag').val(obj.sub_rat_flag);
...
<script>
    function updateStatus(status, iSubCategoryId) {
        //$("p").toggle();
        $('#loading').css("display", "block");
        $.ajax({
            type: 'POST',
            url: "{{ route('sub_categories.updateStatus') }}",
            data: {
                status: status,
...
<script>
    function checkAll(source) {
        checkboxes = document.querySelectorAll('input[name="iSubCategoryIds[]"]');
        checkboxes.forEach(checkbox => checkbox.checked = source.checked);
    }

    function confirmBulkDelete() {
        const selected = document.querySelectorAll('input[name="iSubCategoryIds[]"]:checked');
    ...
    function confirmSingleDelete(id) {
        Swal.fire({
            ...
            if (result.value) {
                fetch("{{ route('sub_categories.delete', ['id' => '__id__']) }}".replace('__id__', id), {
                        method: "DELETE",
                        headers: {
                    ...
                    .then(data => {
                        if (data.success) {
                            Swal.fire({
                                ...
                                // Redirect to sub_categories.index after successful deletion
...
<script>
    function validateFile() {
        ...
        var fileExtension = document.getElementById('SubCategoryimage').value.split('.').pop().toLowerCase();
...
<script>
    function EditvalidateFile() {
        //alert('hello');
        var allowedExtension = ['jpeg', 'jpg', 'png', 'webp', ''];
        var fileExtension = document.getElementById('EditSubCategoryimage').value.split('.').pop().toLowerCase();
        var isValidFile = false;
        var image = document.getElementById('EditSubCategoryimage').value;
        for (var index in allowedExtension) {
            if (fileExtension === allowedExtension[index]) {
                isValidFile = true;
                break;
