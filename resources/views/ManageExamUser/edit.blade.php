        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                ...
                <ul class="flex items-center gap-2 text-sm font-normal shrink-0">
                    ...
                    <li
                        class="relative before:content-['\ea54'] before:font-remix ltr:before:-right-1 rtl:before:-left-1  before:absolute before:text-[18px] before:-top-[3px] ltr:pr-4 rtl:pl-4 before:text-slate-400 dark:text-zink-200">
                        <a href="{{ route('manage_exam_user.index') }}" class="text-slate-400 dark:text-zink-200">User
                            List</a>
                    </li>
                                ...
                                <div class="rtl:md:text-start">
                                    <div class="bg-white shadow rounded-md dark:bg-zink-600">
                                        <div
                                            ...
                                            <a href="{{ route('manage_exam_user.index') }}">
                                                <button type="button"
                                        ...
                                        <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                                            <form onsubmit="return EditvalidateFile()" class="tablelist-form"
                                                action="{{ route('manage_exam_user.update', $examsuser->Exam_User_id) }}"
                                                method="POST" enctype="multipart/form-data">
                                                @csrf

                                                <input type="hidden" name="Exam_User_id" id="Exam_User_id"
                                                    value="{{ $examsuser->Exam_User_id }}">
                                                ...
                                                <div class="grid grid-cols-3 gap-4">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="name" id="name"
                                                            value="{{ $examsuser->name }}" maxlength="150"
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="login_id" id="login_id"
                                                            value="{{ $examsuser->login_id }}" maxlength="150"
                                                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                            placeholder="Enter Name" autocomplete="off" autofocus>
                                                        ...
                                                        <select id="Categoryid" name="Categoryid"
                                                            ...
                                                            @foreach ($categories as $category)
                                                                <option value="{{ $category->Categories_id }}"
                                                                    @selected($category->Categories_id == $examsuser->cate_id)>
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="email-field"
                                                            class="inline-block mb-2 text-base font-medium">Exam</label>
                                                        <select id="Categoryid" name="examid"
                                                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                                            <option value="" disabled>Select a Category</option>
                                                            @foreach ($exams as $exam)
                                                                <option value="{{ $exam->Exam_master_id }}"
                                                                    @selected($exam->Exam_master_id == $examsuser->exam_id)>
                                                                    {{ $exam->Exam_name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    ...
                                                    <!--        value="{{ $examsuser->password }}" maxlength="150"-->
                                                    <!--        class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"-->
