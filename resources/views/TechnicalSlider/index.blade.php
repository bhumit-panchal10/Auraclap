...
@section('title', 'Technicial Slider List')
@section('content')
    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Technicial Slider List</h5>
                </div>
                                ...
                                <div class="rtl:md:text-start">
                                    <div class="bg-white shadow rounded-md dark:bg-zink-600">
                                        <div
                                            ...
                                            <h5 class="text-16" id="exampleModalLabel">Add Slider</h5>
                                        </div>
                                        <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                                            <form onsubmit="return validateFile()" class="tablelist-form"
                                                action="{{ route('Technicialslider.store') }}" method="POST"
                                                ...
                                                <div class="mb-3">
                                                    <label for="email-field" class="">link</label>
                    ...
                    <div class="card" id="customerList">
                        <div class="card-body">
                            ...
                            <div class="overflow-x-auto">
                                @if (!$Sliders->isEmpty())
                                    <form id="bulkDeleteForm" method="POST" action="{{ route('Technicialslider.deleteselected') }}">
                                        @csrf
                                        @method('DELETE')
                                                ...
                                                @foreach ($Sliders as $Slider)
                                                    <tr>
                                                        ...
                                                        <td
                                                            ...
                                                            @if ($Slider->image)
                                                                <img class="img-fluid"
                                                                    src="{{ asset('upload/TechnicialSlider-images') . '/' . $Slider->image }}"
                                                            ...
                                                            <div class="flex gap-2">
                                                                <div class="edit">
                                                                    <a class="mx-1" title="Edit" href="#"
                                                                        ...
                                                                        onclick="getEditData(<?= $Slider->id ?>)">
                                                                        <i class="ri-edit-2-fill"></i>
                                                                    </a>
                                                                    <a class="mx-1" title="Delete" href="#"
                                                                        onclick="confirmSingleDelete({{ $Slider->id }})">
            ...
            <div id="EditModal" modal-center=""
                ...
                <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
                    <div class="flex items-center justify-between p-4 border-b border-slate-200 dark:border-zink-500">
                        <h5 class="text-16" id="exampleModalLabel">Edit Slider</h5>
                    ...
                    <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                        <form class="tablelist-form" onsubmit="return EditvalidateFile()"
                            action="{{ route('Technicialslider.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="flex justify-end gap-2">
                                ...
                                <a href="{{ route('Technicialslider.index') }}">
                                    <button type="button"
                                        class="text-white transition-all duration-200 ease-linear btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">
                                        Cancel
                                    </button>
    ...
    <script>
        function checkAll(source) {
            checkboxes = document.querySelectorAll('input[name="slider_ids[]"]');
            checkboxes.forEach(checkbox => checkbox.checked = source.checked);
        }


        function getEditData(id) {
            var url = "{{ route('Technicialslider.edit', ':id') }}";
            ...
            if (id) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var imageUrl = obj.image ? "{{ asset('upload/TechnicialSlider-images') }}/" + obj
        ...
        function confirmBulkDelete() {
            const selected = document.querySelectorAll('input[name="slider_ids[]"]:checked');
        ...
        function confirmSingleDelete(id) {
            Swal.fire({
                ...
                if (result.value) {
                    fetch('{{ route('Technicialslider.delete', ['id' => '__id__']) }}'.replace('__id__', id), {
                            method: 'DELETE',
                            headers: {
                        ...
                        .then(data => {
                            if (data.success) {
                                Swal.fire({
                                    ...
                                    window.location.href = `{{ route('Technicialslider.index') }}`;
                                });
                            } else {
                                Swal.fire({
                                    title: 'Error!',
