    ...
    <div
        ...
        <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
            ...
            <div class="flex flex-col gap-2 py-4 md:flex-row md:items-center print:hidden">
                <div class="grow">
                    <h5 class="text-16">Slider List</h5>
                </div>
                            ...
                            <div class="overflow-x-auto">
                                @if (!$Sliders->isEmpty())
                                    <form id="bulkDeleteForm" method="POST"
                                        action="{{ route('slider.deleteselected') }}">
                                        @csrf
                                        @method('DELETE')
                                                ...
                                                @foreach ($Sliders as $Slider)
                                                    <tr>
                                                        ...
                                                        <td
                                                            ...
                                                            @if ($Slider->image)
                                                                <img class="img-fluid"
                                                                    src="{{ asset('upload/Slider-images') . '/' . $Slider->image }}"
                ...
                <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
                    ...
                    <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4">
                        <form class="tablelist-form" onsubmit="return EditvalidateFile()"
                            action="{{ route('slider.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
    ...
    <script>
            ...
            if (id) {
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var imageUrl = obj.image ? "{{ asset('upload/Slider-images') }}/" + obj
        ...
        function confirmSingleDelete(id) {
            Swal.fire({
                ...
                if (result.value) {
                    fetch('{{ route('slider.delete', ['id' => '__id__']) }}'.replace('__id__', id), {
                            method: 'DELETE',
                            headers: {
